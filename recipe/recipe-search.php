...
// 模糊比對：
$sql="SELECT * , users.name AS user_name  FROM recipe JOIN users ON recipe.user_id=users.id WHERE title LIKE'%$search%'";
...
<html lang="en">
  ...
  <body>
      <div class="container">
        <div class="py-2">
        <a class="btn btn-info" href="recipe-all.php">所有食譜</a>
        </div>
